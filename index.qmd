...
::: {.column-margin}
{{< video https://youtu.be/adiKi-BmywI >}}

<small>"Mind Train" live, Kyoto, 13 July 2024.</small>
...
A black-and-white motion graphics video that continues the monochromatic aesthetic that has characterized Oyamada's work since *Mellow Waves* (2017), the video at first sight recalls an animated music visualizer, or the fractal zooms of early computer art that have inspired an entire YouTube genre of fly-through fractal movies. It starts out rather straightforwardly, as a POV shot from the front of a train speeding along an endless track through a virtual landscape, through arches, tunnels, and across bridges. The train **track** is as a visual metaphor for the musical track, as we realize that as in "Audio Architecture" we are inside a three-dimensional sequencer with the moving POV as a virtual playhead that passes through an array of musical objects: clusters of floating orbs, a flock of seagulls, geometric shapes. This is also a journey into the **mind**, however, and in an abrupt segue the train/playhead plunges through a kind of neural network of the memory itself, with words appearing as they are sung on the audio track (remain, memory, brain, memory, again). After a guitar solo visualized by a corridor of pulsating strings (reminiscent of the "meet the soundtrack" sequence in *Fantasia*), the music appears to disintegate as we emerge in a hyperspace of randomly floating musical objects, arriving at a planet/trackball that pauses the playback. In the video's most fascinating sequence, a comet, meteorites, clusters of satellites, and rings visualize musical patterns and motifs against an ethereal audiovisual space. The three-dimensional objects here recall those of animated computer art, but their dynamic movement generates corresponding musical patterns: squiggly lines make squiggly music (or vice versa). The next section most closely resembles the algorithmic music visualizers of contemporary electronic music, before we return to the virtual train ride as the video moves to its conclusion.
