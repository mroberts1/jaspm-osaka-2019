...
Continuing the monochromatic minimalism of Oyamada's work since *Mellow Waves* (2017), the motion graphics video depicts a single POV shot of a virtual train speeding along an endless *track* that becomes a visual metaphor for the musical track synchronized with it. Superficially, the video recalls the ubiquitous YouTube genre of "fractal movies," inspired by the fractal zooms of early computational art, or one of the generative music videos popular among experimental electronic musicians. But there is more to it than this. As with "Audio Architecture," "Mind Train" places us inside a three-dimensional sequencer, as animated sound objects are triggered like MIDI notes by the passing train/playhead. As the song's title indicates, however, the ride is also a cosmic voyage through the **mind**: around the midpoint, the viewpoint plunges into a kind of wormhole maze reminiscent of neural networks, emerging in a hyperspace of floating planetary orbs where the music grinds to a halt for a few seconds; the central planet turns out to be a kind of mouseball whose movement retriggers the music.
